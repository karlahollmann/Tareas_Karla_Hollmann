...
plt.subplot(231)
plt.plot(mrf1.timef(),mrf1.posf(),label="y0=-3m, t=10s, gamma=3(1/s)",color='green')
plt.legend(fontsize=13)
plt.title('Posicion vs Tiempo, m=1kg, k=2N/m')
plt.ylabel('Posicion y (m)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(232)
plt.plot(mrf2.timef(),mrf2.posf(), label="y0=5m, t=10s, gamma=3(1/s)",color='green')
plt.legend(fontsize=13)
plt.title('Posicion vs Tiempo, m=1kg, k=2N/m')
plt.ylabel('Posicion y (m)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(233)
plt.plot(mrf3.timef(),mrf3.posf(), label="y0=-0.4m, t=10s, gamma=3(1/s)", color='green')
plt.legend(fontsize=13)
plt.title('Posicion vs Tiempo, m=1kg, k=2N/m')
plt.ylabel('Posicion y (m)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(234)
plt.plot(mrf4.timef(),mrf4.posf(), label="y0=-3m, t=10s, gamma=0.1(1/s)")
plt.legend(fontsize=13)
plt.title('Posicion vs Tiempo, m=5kg, k=1N/m')
plt.ylabel('Posicion y (m)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(235)
plt.plot(mrf5.timef(),mrf5.posf(), label="y0=5m, t=10s, gamma=0.1(1/s)")
plt.legend(fontsize=13)
plt.title('Posicion vs Tiempo, m=5kg, k=1N/m')
plt.ylabel('Posicion y (m)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(236)
plt.plot(mrf6.timef(),mrf6.posf(), label="y0=-0.4m, t=10s, gamma=0.1(1/s)")
plt.legend(fontsize=13)
plt.title('Posicion vs Tiempo, m=5kg, k=1N/m')
plt.ylabel('Posicion y (m)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(231)
plt.plot(mrf1.timef(),mrf1.velf(),label="y0=-3m, t=10s, gamma=3(1/s)",color='green')
plt.legend(fontsize=13)
plt.title('Velocidad vs Tiempo, m=1kg, k=2N/m')
plt.ylabel('Velocidad (m/s²)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(232)
plt.plot(mrf2.timef(),mrf2.velf(), label="y0=5m, t=10s, gamma=3(1/s)",color='green')
plt.legend(fontsize=13)
plt.title('Velocidad vs Tiempo, m=1kg, k=2N/m')
plt.ylabel('Velocidad (m/s²)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(233)
plt.plot(mrf3.timef(),mrf3.velf(), label="y0=-0.4m, t=10s, gamma=3(1/s)", color='green')
plt.legend(fontsize=13)
plt.title('Velocidad vs Tiempo, m=1kg, k=2N/m')
plt.ylabel('Velocidad (m/s²)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(234)
plt.plot(mrf4.timef(),mrf4.velf(), label="y0=-3m, t=10s, gamma=0.1(1/s)")
plt.legend(fontsize=13)
...
plt.subplot(235)
plt.plot(mrf5.timef(),mrf5.velf(), label="y0=5m, t=10s, gamma=0.1(1/s)")
plt.legend(fontsize=13)
plt.title('Velocidad vs Tiempo, m=5kg, k=1N/m')
plt.ylabel('Velocidad (m/s²)')
plt.xlabel('Tiempo (s)')
...
plt.subplot(236)
plt.plot(mrf6.timef(),mrf6.velf(), label="y0=-0.4m, t=10s, gamma=0.1(1/s)")
plt.legend(fontsize=13)
plt.title('Velocidad vs Tiempo, m=5kg, k=1N/m')
plt.ylabel('Velocidad (m/s²)')
plt.xlabel('Tiempo (s)')
